...
/**
 * Implementation of {@link Resource.Diagnostic} for QVT-O parse errors,
 * carrying line, column, and message information from ANTLR4.
 *
 * @author Data In Motion Consulting
 * @since 1.0
 */
class QvtoParseDiagnostic implements Resource.Diagnostic {
	...
	QvtoParseDiagnostic(String message, int line, int column) {
