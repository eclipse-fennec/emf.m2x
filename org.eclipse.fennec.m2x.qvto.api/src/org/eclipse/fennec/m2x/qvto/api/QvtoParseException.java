...
/**
 * Checked exception thrown when a QVT-O transformation source cannot be parsed.
 *
 ...
 * @since 1.0
 */
public class QvtoParseException extends Exception {
	...
	public QvtoParseException(String message) {
	...
	public QvtoParseException(String message, Throwable cause, List<Resource.Diagnostic> errors) {
		super(Objects.requireNonNull(message, "message must not be null"), cause);
		this.errors = List.copyOf(Objects.requireNonNull(errors, "errors must not be null"));
	}
