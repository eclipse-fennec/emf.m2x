...
public final class QvtdConfiguration {
	 ...
	 *
	 * <p>Supplying an engine is how QVT-R uses the one that was configured elsewhere — the
	 ...
	 */
	/**
	 * Whether the engine also asks {@link QvtdUnitResolver} implementations it finds itself,
	...
	public static final class Builder {
		 ...
		 */
		/**
		 * Sets the resource set whose package registry resolves the transformation's typed models.
		 *
		 ...
		 */
		/**
		 * Lets the engine ask {@link QvtdUnitResolver} implementations it discovers, on top
