...
/**
 * Checked exception thrown when a QVT-R transformation source cannot be parsed.
 *
 ...
 * @since 1.0
 */
public class QvtdParseException extends Exception {

	private static final long serialVersionUID = 1L;

	private final List<Resource.Diagnostic> errors;

	public QvtdParseException(String message, List<Resource.Diagnostic> errors) {
		super(Objects.requireNonNull(message, "message must not be null"));
		this.errors = List.copyOf(Objects.requireNonNull(errors, "errors must not be null"));
	}

	public QvtdParseException(String message) {
		this(message, Collections.emptyList());
	}

	public QvtdParseException(String message, Throwable cause) {
