...
public class QvtOLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__154", "T__155", "T__156", "LINE_COMMENT", "RESET_ASSIGN", "ADD_ASSIGN", 
			"ORDERED_COPY", "SUBTRACT_ASSIGN", "DOUBLE_HASH", "HASH", "DOUBLE_EQUAL", 
			...
			"IDENTIFIER", "LETTER", "WS", "BLOCK_COMMENT"
		};
	}
	...
	public QvtOLexer(CharStream input) {
		super(input);
