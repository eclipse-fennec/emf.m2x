...
/**
 * Registers the Fennec OCL invocation delegate under the legacy Eclipse OCL
 * Pivot delegate URI ({@value OclDelegateUtil#LEGACY_PIVOT_URI}).
 *
 * <p>This is a thin OSGi wrapper around {@link OclInvocationDelegateFactory}: the
...
public class OclLegacyPivotInvocationDelegateFactory extends OclInvocationDelegateFactory {
