...
import org.eclipse.fennec.m2m.ocl.engine.OclLruExpressionCache;
 ...
 *
 * <p>Run via: {@code ./gradlew org.eclipse.fennec.m2m.ocl.tests:perfTest}
 *
...
class OclPerformanceTest {
	...
	void p13_rapidFireRangeLimit(TestInfo info) throws OclParseException {
		...
		var opts = org.eclipse.fennec.m2m.ocl.api.OclEvaluationOptions.strict()
