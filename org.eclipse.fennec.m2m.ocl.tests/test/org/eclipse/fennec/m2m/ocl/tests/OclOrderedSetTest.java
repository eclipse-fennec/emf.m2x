...
class OclOrderedSetTest extends AbstractOclTest {
	...
	void orderedSet_removeDuplicates() throws OclParseException {
		assertEquals(3L, eval("OrderedSet{1, 2, 2, 3, 3}->size()", self));
	}
	...
	void orderedSet_indexOf() throws OclParseException {
		assertEquals(2L, eval("OrderedSet{10, 20, 30}->indexOf(20)", self));
	}
	...
	void orderedSet_append() throws OclParseException {
		assertEquals(4L, eval("OrderedSet{1, 2, 3}->append(4)->last()", self));
	}

	@Test
	void orderedSet_prepend() throws OclParseException {
		assertEquals(0L, eval("OrderedSet{1, 2, 3}->prepend(0)->first()", self));
	}

	@Test
	void orderedSet_append_newElement() throws OclParseException {
		assertEquals(4L, eval("OrderedSet{1, 2, 3}->append(4)->size()", self));
	}
	...
	void orderedSet_reverse() throws OclParseException {
		assertEquals(3L, eval("OrderedSet{1, 2, 3}->reverse()->first()", self));
	}
	...
	void orderedSet_select() throws OclParseException {
		assertEquals(2L, eval("OrderedSet{1, 2, 3, 4}->select(i | i > 2)->size()", self));
	}
	...
	void orderedSet_asSequence() throws OclParseException {
		assertEquals(1L, eval("OrderedSet{1, 2, 3}->asSequence()->first()", self));
	}

	@Test
	void orderedSet_asSet() throws OclParseException {
		assertEquals(3L, eval("OrderedSet{1, 2, 3}->asSet()->size()", self));
	}
