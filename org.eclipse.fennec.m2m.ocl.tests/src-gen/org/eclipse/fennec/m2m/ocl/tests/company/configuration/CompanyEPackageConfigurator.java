...
public class CompanyEPackageConfigurator implements EPackageConfigurator {
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(CompanyPackage.eNS_URI, ePackage);
	}
	...
	public void unconfigureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.remove(CompanyPackage.eNS_URI);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, CompanyPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, CompanyPackage.eNS_URI);
