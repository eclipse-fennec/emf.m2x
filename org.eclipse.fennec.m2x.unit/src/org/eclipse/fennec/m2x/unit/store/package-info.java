 ...
 * nothing. The store owns the serialization: a document goes in as XMI and comes out as an
 * independent copy in a fresh resource set (§5.5 of the compiled-unit concept).
 */
