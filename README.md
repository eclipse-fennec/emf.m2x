...
|--------|-------------|--------|
| `org.eclipse.fennec.m2x.unit` | `CompiledUnit` metamodel (manifest, script, satellites, embedded units), `SatelliteCollector` + `UnitPackager` behind `compile()`, the `m2x1` unit fingerprint, store / prepared-context contracts | In progress |
| `org.eclipse.fennec.m2x.unit.tests` | 58 tests, 0 failures | In progress |
...
| `org.eclipse.fennec.m2x.qvto.tests` | 1,175 tests (1 disabled), 0 failures | Done |
...
| `org.eclipse.fennec.m2x.qvtd.tests` | 204 tests (2 disabled), 0 failures | Done |
...
| `org.eclipse.fennec.m2x.m2t.tests` | 362 tests (1 disabled), 0 failures | Done |
