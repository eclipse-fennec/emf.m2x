...
public class M2tServiceUnitResolver implements M2tUnitResolver {
	...
	private final OsgiServiceUnitResolver<M2tUnitResolver, M2tUnit> discovery;
	...
	public M2tServiceUnitResolver(BundleContext context) {
		this.discovery = new OsgiServiceUnitResolver<>(context, M2tUnitResolver.class,
				UNIT_NAME, RESOLVER_KIND, M2tUnitResolver::resolveUnit);
	}
