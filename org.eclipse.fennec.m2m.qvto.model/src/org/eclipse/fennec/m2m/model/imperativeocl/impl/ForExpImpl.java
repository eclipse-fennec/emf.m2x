 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.m2m.model.imperativeocl.impl.ForExpImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForExpImpl extends ImperativeLoopExpImpl implements ForExp {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImperativeOclPackage.FOR_EXP__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImperativeOclPackage.FOR_EXP__NAME:
				return getName();
		}
