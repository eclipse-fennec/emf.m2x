 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.fennec.m2x.model.imperativeocl.util.ImperativeOclResourceImpl
 * @generated
 */
public class ImperativeOclResourceFactoryImpl extends ResourceFactoryImpl {
	/**
	...
	public Resource createResource(URI uri) {
		Resource result = new ImperativeOclResourceImpl(uri);
		return result;
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_CONFIGURATOR_NAME, ImperativeOclPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, "imperativeocl");
		properties.put(EMFNamespaces.EMF_MODEL_VERSION, "1.0");
		return properties;
	}

} //ImperativeOclResourceFactoryImpl
